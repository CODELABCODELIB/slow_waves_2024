function OUTEEG = gettechnicallycleanEEG_sw(INEEG, bandpass_upper_range,bandpass_lower_range)
...
%
% Note sw edit! removed Re-reference to average channel and no bandpass filter
%%
...
if ~isempty(bandpass_lower_range)
% Remove if slow
...
OUTEEG = eeg_checkset(INEEG); % use this re-ref to avg reference.
